    ...
    <div className="space-y-3 pt-4 border-t border-border">
      ...
      <div className="relative">
        <input
          ...
          placeholder={
            messages["actions.customizePlaceholder"] ||
            "Optional: Add your preferences (e.g., 'make it spicy', 'no dairy')..."
          }
          className={cn(
      ...
      <div className="flex flex-wrap gap-2">
        ...
        >
          {isShoppingListLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : <ShoppingCart className="w-4 h-4" />}
